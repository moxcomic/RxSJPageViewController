...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxSJPageViewController/RxSJPageViewController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RxSwift/RxSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SJPageViewController/SJPageViewController.framework"
fi
